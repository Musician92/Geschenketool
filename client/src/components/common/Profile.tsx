...
import { ProfileProps, PresentProps } from "interfaces/common";
...
const Profile = ({ type, name, avatar, email, presents}: ProfileProps) => (
    <Box>
                                    ...
                                    <Stack flex={1} gap="15px">
                                        ...
                                        >
                                            ...
                                            <Typography
                                                ...
                                                noWrap
                                            >
                                                +0123 Pls-Call-Me-I-Am-Desperate
                                            </Typography>
                                        </Box>
                                    </Stack>
        ...
        {presents.length > 0 && (
            <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#FCFCFC">
                ...
                >
                    {presents?.map((present: PresentProps) => (
                        <PresentCard
                            key={present._id}
                            id={present._id}
                            title={present.title}
